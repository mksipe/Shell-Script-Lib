#!/bin/sh
echo "This type of configuration is not possible via shell script. A file containing instructions on how to fix this has been created."
touch ARP\ Instructions.txt
chmod 755 ARP\ Instructions.txt
...
credit : https://askubuntu.com/questions/663707/how-to-prevent-arp-spoofing " >> ARP\ instructions.txt